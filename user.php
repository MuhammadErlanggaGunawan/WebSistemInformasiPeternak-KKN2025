...
$query = "
    SELECT id_user, username, email, nama_lengkap, alamat, no_hp, role, created_at
    FROM users
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4 mb-4">Daftar Users</h1>
                        <div class="card mb-4">
                            <div class="card-header d-flex justify-content-end">
                                <button type="button" class="btn btn-primary" onclick="window.location.href='tambah_user.php'">
                                            ...
                                            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                                <tr>
                                                    ...
                                                    <td class="d-flex justify-content-center align-items-center">
                                                        <button type="button" class="btn btn-dark m-2" onclick="editUser(<?= $row['id_user'] ?>)">
                                                            <i class="fa fa-pen me-2"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-danger" onclick="deleteUser(<?= $row['id_user'] ?>)">
